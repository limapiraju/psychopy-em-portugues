...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\limap\\OneDrive\\Área de Trabalho\\Aula 062 – Sider com Alternativas Aleatorizadas\\federal_units_of_brazil_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    # itera problemas para gerar conjunto com resposta correta e duas alternativas incorretas distintas
    ...
    for thisTrial in trials:
        ...
        idx = item_slider.getRating() # "0", "1" ou "2"
        ...
        thisExp.addData("alt1", alternatives[trials.thisN][0])
        thisExp.addData("alt2", alternatives[trials.thisN][1])
        thisExp.addData("alt3", alternatives[trials.thisN][2])
