...
expName = 'clock v. 3'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\Python_files\\PsychoPy\\YouTube\\Aulas\\Aula 030 – Relógios\\exemplo 3\\clock v. 3_lastrun.py',
...
for thisTrial in trials:
    ...
    color = "green"
    relogio = core.CountdownTimer(start = 10)
    ...
    while continueRoutine:
        ...
        if text.status == STARTED:  # only update if drawing
            ...
            text.setText(f"{relogio.getTime():.0f}", log=False)
