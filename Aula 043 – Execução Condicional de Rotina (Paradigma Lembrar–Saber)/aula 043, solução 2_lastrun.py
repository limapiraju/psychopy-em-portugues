...
expName = 'aula043_solucao2'  # from the Builder filename that created this script
expInfo = {
    'participante': '',
}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\limap\\OneDrive\\Área de Trabalho\\Aula 043\\aula 043, solução 2_lastrun.py',
