...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\limap\\OneDrive\\Área de Trabalho\\Aula 057 – Instrumentos de Autorrelato\\questionario-de-ansiedade-com-o-spss_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    saq_slider = visual.Slider(win=win, name='saq_slider',
        startValue=3, size=(1.4, 0.1), pos=(0, -0.5), units='norm',
    ...
    for thisQuestionnaire in questionnaire:
        ...
        saq_slider.reset()
        # keep track of which components have finished
        itemComponents = [saq_item, saq_slider]
        ...
        while continueRoutine:
            ...
            # Check saq_slider for response to end Routine
            if saq_slider.getRating() is not None and saq_slider.status == STARTED:
                continueRoutine = False
