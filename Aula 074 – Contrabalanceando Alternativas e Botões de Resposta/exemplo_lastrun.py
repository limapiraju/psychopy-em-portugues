...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\limap\\OneDrive\\Área de Trabalho\\Aula 074 – Contrabalanceando Alternativas e Botões de Resposta\\exemplo_lastrun.py',
