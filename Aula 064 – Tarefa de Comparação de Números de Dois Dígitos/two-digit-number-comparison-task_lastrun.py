...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\limap\\OneDrive\\Documentos\\Psychology\\8. YouTube\\psychopy-em-portugues\\Aula 064 – Tarefa de Comparação de Números de Dois Dígitos\\two-digit-number-comparison-task_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisBlock in blocks:
        ...
        if blocks.thisN == (total_blocks / 2 - 1):
            ...
            timer = core.CountdownTimer(start = 300)
            timer_color = "green"
        ...
        # pausas opcionais nos demais ciclos
            ...
            timer = core.CountdownTimer(start = 60)
            timer_color = "green"
