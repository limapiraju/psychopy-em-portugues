...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\limap\\OneDrive\\Área de Trabalho\\Python para Psicólogos\\psychopy-em-portugues\\Aula 035 – Loop de Três Níveis\\finley_et_al_lastrun.py',
...
# Run 'Begin Experiment' code from practice_code
print("all_rows:")
print(all_rows)
    ...
    for thisPractice_phase_cycle in practice_phase_cycles:
        ...
        for thisPractice_phase_trial in practice_phase_trials:
            ...
            if current_condition == "acumulação":
                ...
                # ...
                # rodada 6: x = 0, y = 5
                letters = [0] * (5 - practice_phase_cycles.thisN) + [1] * practice_phase_cycles.thisN
                ...
                # ...
                # rodada 6: x = 5, y = 0
                letters = [0] * (practice_phase_cycles.thisN) + [1] * (5 - practice_phase_cycles.thisN)
