...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\limap\\OneDrive\\Área de Trabalho\\Aula 075 – Cor do Fundo da Tela\\exemplo.py',
...
def setupWindow(expInfo=None, win=None):
    ...
    if win is None:
        ...
        win = visual.Window(
            ...
            monitor='testMonitor', color='-0.2157, 0.1686, 0.8588', colorSpace='rgb',
        ...
        win.color = '-0.2157, 0.1686, 0.8588'
        win.colorSpace = 'rgb'
        win.backgroundImage = ''
