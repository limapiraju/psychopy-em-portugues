...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\limap\\OneDrive\\Área de Trabalho\\Aula 071 – Keep Track Task\\keep-track-task.py',
...
for thisKeeping_track_trial in keeping_track_trials:
    ...
    # set up handler to look after randomisation of conditions etc
    keeping_track_word = data.TrialHandler(nReps=15.0, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=[None],
    ...
    # completed 15.0 repeats of 'keeping_track_word'
