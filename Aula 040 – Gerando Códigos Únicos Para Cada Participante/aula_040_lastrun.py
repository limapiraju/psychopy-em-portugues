...
while True:
    new_ID = codigo(5) # código com 5 caracteres
    choque = False
...
expName = 'aula_040'  # from the Builder filename that created this script
expInfo = {
    'participant': '',
    'session': '001',
}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\limap\\OneDrive\\Área de Trabalho\\Aula 040\\aula_040_lastrun.py',
...
Daqui em diante, seus dados serão analisados de forma anônima, por meio do seguinte código: {new_ID}.
...
thisExp.addData("condição experimental", color)
thisExp.addData("ID_participante", new_ID)
